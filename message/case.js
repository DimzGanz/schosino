...
var ownerNumber = [`${nomerOwner}@s.whatsapp.net`,`6289696764138@s.whatsapp.net`,`${alice.user.jid}`]
...
alice.sendMessage(m.chat, {
      ...
      alice.reply(m.sender, `gapunya grup😁`, m)
}
break
case 'rules':{
let teks =`
...
case "fetch":
  if (!q) {
    return reply(`Contoh:\n${prefix + command} https://github.com/DimzGanz`);
  }
  if (!/^https?:\/\//.test(q)) {
...
alice.sendMessage(from, { contextInfo: {externalAdReply: {showAdAttribution: true, title: `Dimas Bot`, mediaType: 3,  renderLargerThumbnail : true,thumbnailUrl:"https://telegra.ph/file/33d58a3a7b931d3902642.jpg",sourceUrl: `https://wa.me/${nomerOwner}`
...
alice.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `Dimas Bot`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/ehanzdhoanx`,}
